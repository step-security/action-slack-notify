			...
			Attachments: []Attachment{
				{
					...
					Footer:     envOr(EnvSlackFooter, "<https://github.com/step-security/github-actions-library|Powered By step-security's GitHub Actions Library> | <"+getEnv(EnvGithubRun)+"|Triggered on this workflow run>"),
					Fields:     fields,
				},
			},
		}
